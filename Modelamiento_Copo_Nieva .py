...
#CARGA DE DATOS EN EL MODELO ESTRELLA
...
def transform():
    ...
    log(logfile, "-------------------------------------------------------------")
    return df_fact_sales,df_customers,df_employees,df_location,df_product,df_shipper,df_category,df_supplier
   
def load():
    """ Connect to the PostgreSQL database server """
    conn_string = 'postgresql://postgres:172164@localhost/DW_liquor_sale_Copo_Nieve'
    ...
    try:
        ...
        df_fact_sales.to_sql('Fact_sales_liquor', conn, if_exists='append',index=False)
...
if __name__ == '__main__':
    ...
    extract()
    (df_fact_sales,df_customers,df_employees,df_location,df_product,df_shipper,df_category,df_supplier) = transform()
    load()
